...
export default function AdminLayout() {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: "#f4f2ea" }}>
      <aside style={{ width: 230, background: "var(--ink)", color: "#dfe4f2", padding: "20px 14px", position: "sticky", top: 0, height: "100vh" }}>
