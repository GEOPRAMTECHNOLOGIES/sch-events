      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="card" style={{ padding: 20, marginBottom: 20 }}>
            ...
            <div className="field">
              ...
              {form.coverImageUrl && (
                <img
                  ...
                  alt=""
                  style={{ width: "100%", maxWidth: 220, aspectRatio: "16/9", objectFit: "cover", borderRadius: 10, marginTop: 8, border: "1px solid var(--mist)" }}
          ...
          {form.gallery.map((g, i) => (
            <div key={i} style={{ display: "grid", gridTemplateColumns: "56px 2fr 1fr auto", gap: 8, marginBottom: 8, alignItems: "center" }}>
              {g.url ? (
                <img
                  src={g.url}
                  alt=""
                  style={{ width: 56, height: 40, objectFit: "cover", borderRadius: 6, border: "1px solid var(--mist)" }}
                  onError={(e) => (e.target.style.visibility = "hidden")}
                />
              ) : (
                <div style={{ width: 56, height: 40, borderRadius: 6, background: "var(--paper-dim)" }} />
              )}
